...
function createPlantCard(plant) {
    ...
    return `            
              <section class="card-section">
                ...
                <p class="inside-page__text"><strong>Dimension:</strong> ${plant.dimension}</p>
                <p class="inside-page__text"><strong>Propogation:</strong> ${plant.propogation}</p>
                <p class="inside-page__text"><strong>Water Needs:</strong> ${plant.watering}</p> <p class="inside-page__text">Sunlight needs: ${plant.sunlight}</p>
                <p class="inside-page__text"><strong>Pruning Month:</strong> ${plant.pruning_month}</p>
                <p class="inside-page__text"><strong>Growth Rate:</strong> ${plant.growth_rate}</p>
                <p class="inside-page__text"><strong>Harvest Season:</strong> ${plant.harvest_season}</p>
                <p class="inside-page__text"><strong>Flower Color:</strong> ${plant.flower_color}</p>
                </div>
                </div>
                </li>`
